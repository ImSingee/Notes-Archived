---
title: Redis源码剖析与实战_Redis_Redis源码_数据结构_主从复制_缓存_集群_分布式数据库_键值数据库_事件驱动框架-极客时间 (highlights)
---
...
- Highlights first synced by #Readwise [[August 16th, 2021]]
	 - 压缩列表（ziplist）
...
- New highlights added [[August 17th, 2021]] at 11:01 AM
